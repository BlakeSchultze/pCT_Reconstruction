...
/***************************************************************************************************************************************************************************/
enum BIN_ANALYSIS_TYPE { MEANS, COUNTS, MEMBERS };						// Types of information that may be desired about the data corresponding to each bin
enum BIN_ANALYSIS_FOR { ALL_BINS, SPECIFIC_BINS };						// Types of information that may be desired about the data corresponding to each bin
enum BIN_ORGANIZATION { BY_BIN, BY_HISTORY };							// Types of information that may be desired about the data corresponding to each bin
enum BIN_ANALYSIS_OF { WEPLS, ANGLES, POSITIONS, BINS };				// Types of information that may be desired about the data corresponding to each bin
