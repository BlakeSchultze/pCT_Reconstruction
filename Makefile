...
pCT_Reconstruction.o: src/pCT_Reconstruction_Data_Segments_Blake.cu include/pCT_Reconstruction_Data_Segments_Blake.h
...
clean:
	rm -vf pCT_Reconstruction.o pCT_Reconstruction
