...
#define NUM_LOG_ENTRIES			7
#define OBJECT_ENTRIES_SIZE		64
#define DATE_ENTRIES_SIZE		16
#define TYPE_ENTRIES_SIZE		16	
#define RUN_NUM_ENTRIES_SIZE	32
...
const char* LOG_ITEMS[NUM_LOG_ENTRIES] = {"Object", "Scan Type", "Run Date", "Run Number", "Projection Data Date", "Preprocessing Date", "Reconstruction Date" };