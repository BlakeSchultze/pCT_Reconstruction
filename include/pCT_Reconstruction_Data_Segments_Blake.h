...
#define T_BIN_SIZE				0.0625										// [cm] Distance between adjacent bins in t (lateral) direction
...
#define ANGULAR_BIN_SIZE		3.0										// [degrees] Angle between adjacent bins in angular (rotation) direction
...
#define VOXEL_WIDTH				0.0625										// [cm] Distance between left and right edges of each voxel in image
#define VOXEL_HEIGHT			0.0625										// [cm] Distance between top and bottom edges of each voxel in image
...
float LAMBDA						= 0.0001;								// [#] Relaxation parameter to use in image iterative projection reconstruction algorithms	
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------/
...
#define A							0.5								// [#] Perturbation coefficient generation kernel value: BETA_K_N = A^L
...
const char BASH_COPY_FILE[]			= "cp -av";												// Command to secure copy data/directories between clusters/nodes
const char BASH_COPY_FILE_SILENT[]	= "cp -a";													// Command to secure copy data/directories between clusters/nodes
...
static struct option long_options[] =
{
    ...
    {"exit_after_execution", required_argument, NULL, 29},
    {"close_after_execution", required_argument, NULL, 30},
    {"debug_text_on", required_argument, NULL, 31},
    {"sample_std_dev", required_argument, NULL, 32},
    {"fbp_on", required_argument, NULL, 33},
    {"import_filtered_fbp", required_argument, NULL, 34},
    {"sc_on", required_argument, NULL, 35},
    {"msc_on", required_argument, NULL, 36},
    {"sm_on", required_argument, NULL, 37},
    {"count_0_wepls", required_argument, NULL, 38},
    {"direct_image_reconstruction", required_argument, NULL, 39},
    {"mlp_file_exists", required_argument, NULL, 40},
    {"mlp_endpoints_file_exists", required_argument, NULL, 41},
    {"input_directory", required_argument, NULL, 42},
    {"output_directory", required_argument, NULL, 43},
    {"input_folder", required_argument, NULL, 44},
    {"output_folder", required_argument, NULL, 45},
    {"binary_encoding", required_argument, NULL, 46},
    {"single_data_file", required_argument, NULL, 47},
    {"ssd_in_mm", required_argument, NULL, 48},
    {"data_in_mm", required_argument, NULL, 49},
    {"micah_sim", required_argument, NULL, 50},
    {"write_bin_wepls", required_argument, NULL, 51},
    {"write_wepl_dists", required_argument, NULL, 52},
    {"write_ssd_angles", required_argument, NULL, 53},
    {"write_sc_hull", required_argument, NULL, 54},
    {"write_msc_counts", required_argument, NULL, 55},
    {"write_msc_hull", required_argument, NULL, 56},
    {"write_sm_counts", required_argument, NULL, 57},
    {"write_sm_hull", required_argument, NULL, 58},
    {"write_fbp_image", required_argument, NULL, 59},
    {"write_fbp_hull", required_argument, NULL, 60},
    {"write_avg_fbp", required_argument, NULL, 61},
    {"write_median_fbp", required_argument, NULL, 62},
    {"write_filtered_hull", required_argument, NULL, 63},
    {"write_x_hull", required_argument, NULL, 64},
    {"write_x_0", required_argument, NULL, 65},
    {"write_x_ki", required_argument, NULL, 66},
    {"write_x", required_argument, NULL, 67},
    {"drop_block_size", required_argument, NULL, 68},
    {"threads_per_block", required_argument, NULL, 69},
    {"endpoints_per_block", required_argument, NULL, 70},
    {"histories_per_block", required_argument, NULL, 71},
    {"endpoints_per_thread", required_argument, NULL, 72},
    {"histories_per_thread", required_argument, NULL, 73},
    {"voxels_per_thread", required_argument, NULL, 74},
    {"max_gpu_histories", required_argument, NULL, 75},
    {"max_cuts_histories", required_argument, NULL, 76},
    {"max_endpoints_histories", required_argument, NULL, 77},
    {"max_intersections", required_argument, NULL, 78},
    {"gantry_angle_interval", required_argument, NULL, 79},
    {"gantry_angles", required_argument, NULL, 80},
    {"num_scans", required_argument, NULL, 81},
    {"num_files", required_argument, NULL, 82},
    {"ssd_t_size", required_argument, NULL, 83},
    {"ssd_v_size", required_argument, NULL, 84},
    {"t_shift", required_argument, NULL, 85},
    {"u_shift", required_argument, NULL, 86},
    {"v_shift", required_argument, NULL, 87},
    {"t_bin_size", required_argument, NULL, 88},
    {"t_bins", required_argument, NULL, 89},
    {"v_bin_size", required_argument, NULL, 90},
    {"v_bins", required_argument, NULL, 91},
    {"angular_bin_size", required_argument, NULL, 92},
    {"angular_bins", required_argument, NULL, 93},
    {"num_bins", required_argument, NULL, 94},
    {"sigmas_to_keep", required_argument, NULL, 95},
    {"ram_lak_tau", required_argument, NULL, 96},
    {"fbp_threshold", required_argument, NULL, 97},
    {"recon_cyl_radius", required_argument, NULL, 98},
    {"recon_cyl_diameter", required_argument, NULL, 99},
    {"recon_cyl_height", required_argument, NULL, 100},
    {"image_width", required_argument, NULL, 101},
    {"image_height", required_argument, NULL, 102},
    {"image_thickness", required_argument, NULL, 103},
    {"columns", required_argument, NULL, 104},
    {"rows", required_argument, NULL, 105},
    {"slices", required_argument, NULL, 106},
    {"num_voxels", required_argument, NULL, 107},
    {"voxel_width", required_argument, NULL, 108},
    {"voxel_height", required_argument, NULL, 109},
    {"voxel_thickness", required_argument, NULL, 110},
    {"slice_thickness", required_argument, NULL, 111},
    {"sc_lower_threshold", required_argument, NULL, 112},
    {"sc_upper_threshold", required_argument, NULL, 113},
    {"msc_upper_threshold", required_argument, NULL, 114},
    {"msc_lower_threshold", required_argument, NULL, 115},
    {"msc_diff_thresh", required_argument, NULL, 116},
    {"sm_lower_threshold", required_argument, NULL, 117},
    {"sm_upper_threshold", required_argument, NULL, 118},
    {"sm_scale_threshold", required_argument, NULL, 119},
    {"voxel_step_size", required_argument, NULL, 120},
    {"mlp_u_step", required_argument, NULL, 121},
    {"max_path_elements", required_argument, NULL, 122},
    {"prime_offset", required_argument, NULL, 123},
    {"eta", required_argument, NULL, 124},
    {"method", required_argument, NULL, 125},
    {"psi_sign", required_argument, NULL, 126},
    {"lambda", required_argument, NULL, 127},
    {"iterations", required_argument, NULL, 128},
    {"ignore_short_mlp", required_argument, NULL, 129},
    {"min_mlp_length", required_argument, NULL, 130},
    {"bound_image", required_argument, NULL, 131},
    {"s_curve_on", required_argument, NULL, 132},
    {"sigmoid_steepness", required_argument, NULL, 133},
    {"sigmas_mid_shift", required_argument, NULL, 134},
    {"dual_sided_s_curve", required_argument, NULL, 135},
    {"tvs_on", required_argument, NULL, 136},
    {"tvs_first", required_argument, NULL, 137},
    {"tvs_parallel", required_argument, NULL, 138},
    {"tvs_conditioned", required_argument, NULL, 139},
    {"tvs_min_eta", required_argument, NULL, 140},
    {"tvs_threshold", required_argument, NULL, 141},
    {"a", required_argument, NULL, 142},
    {"l_0", required_argument, NULL, 143},
    {"perturb_down_factor", required_argument, NULL, 144},
    {"l", required_argument, NULL, 145},
    {"beta_0", required_argument, NULL, 146},
    {"beta", required_argument, NULL, 147},
    {"beta_k_n", required_argument, NULL, 148},
    {"tvs_repetitions", required_argument, NULL, 149},
    {"avg_filter_fbp", required_argument, NULL, 150},
    {"avg_filter_hull", required_argument, NULL, 151},
    {"avg_filter_x_0", required_argument, NULL, 152},
    {"median_filter_fbp", required_argument, NULL, 153},
    {"median_filter_hull", required_argument, NULL, 154},
    {"median_filter_x_0", required_argument, NULL, 155},
    {"hull_avg_filter_radius", required_argument, NULL, 156},
    {"fbp_avg_filter_radius", required_argument, NULL, 157},
    {"x_0_avg_filter_radius", required_argument, NULL, 158},
    {"fbp_med_filter_radius", required_argument, NULL, 159},
    {"hull_med_filter_radius", required_argument, NULL, 160},
    {"x_0_med_filter_radius", required_argument, NULL, 161},
    {"hull_avg_filter_threshold", required_argument, NULL, 162},
    {"fbp_avg_filter_threshold", required_argument, NULL, 163},
    {"x_0_avg_filter_threshold", required_argument, NULL, 164},
    {"tested_by_string", required_argument, NULL, 165},
    {"code_owner", required_argument, NULL, 166},
    {"program_version", required_argument, NULL, 167},
    {"section_exit_string", required_argument, NULL, 168},
    {"true_string", required_argument, NULL, 169},
    {"false_string", required_argument, NULL, 170},
    {"on_string", required_argument, NULL, 171},
    {"off_string", required_argument, NULL, 172},
	{"my_recon_dir", required_argument, NULL, 173},
	{"current_git_branch", required_argument, NULL, 174},
	{"tardis_rcode_dir", required_argument, NULL, 175},
...
struct configurations
{
	...
	FBP_FILTER_TYPES		fbp_filter;			  		// Specifies which of the defined filters will be used in FBP
	...
	float tvs_min_eta;								// specify minimum perturbation coefficient to include in precalculated coefficient array 
	...
	float a;									// perturbation coefficient generation kernel value: beta_k_n = a^l
	float l_0;									// initial value of l used in calculating the perturbation coefficient: a^l
	...
	int l;								// variable storing perturbation coefficient kernel exponent l used in calculating the perturbation coefficient: a^l
	...
	UINT tvs_repetitions;								// [#] Specifies # of times to perform TVS for each iteration of DROP
	bool avg_filter_fbp;
